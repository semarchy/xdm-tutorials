/*
 * Oracle Insert Updated Customer Data
 * Semarchy xDM Tutorials
 * Run these insert statements to load customer data
 * changes in the Customer B2C Demo Application.
 * Copyright (c) 2018 Semarchy
 */

/*
 * Step 3: These grants are needed so the procedure can access the relevant tables.
 * Without the grants the insert will fail because of lack of privileges.
 * Run as a user with privileges to execute grants.
 */
 grant SELECT on SEMARCHY_STG.SOURCE_PERSON to SEMARCHY_CUSTOMER_B2C_MDM;

/*
 * Step 4: Insert customer records with data detection to only load
 * customer records with updated information.
